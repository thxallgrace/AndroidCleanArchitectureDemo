...
import com.eunhye.presentation.databinding.ItemMovieBinding

class MovieAdapter(private val itemClick: (Movie) -> Unit) : ListAdapter<Movie, MovieAdapter.ViewHolder>(diffUtil) {
